...
public class ExtentTestNGIReporterListener implements IReporter {
    ...
    public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites, String outputDirectory){
        ...
        /**创建ModuleData对象的列表*/
        moduleDataList = new ArrayList<ModuleData>();
        ...
        for (ISuite suite : suites) {
            ...
            /**设置模块名称*/
            moduleData.setModuleNmae(suite.getName());
            ...
            /**设置成功和失败的测试用例*/
            moduleData.setFailNum(suiteFailSize);
            moduleData.setSuccessNum(suitePassSize);

            /**设置模块总的测试用例数*/
            moduleData.setSunNum(suiteFailSize+suitePassSize+suiteSkipSize);
        ...
        extent.flush();
        try {
            SendMail.sendEmail(moduleDataList);
        }catch (Exception e){
